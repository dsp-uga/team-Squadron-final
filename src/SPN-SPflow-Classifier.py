...
This code is for Sum Product Networks (SPNs), the SPFlow implementation, it gets train on train set and predict on test set and outputs the CSV file for submit to Kaggle.
score 0.67519
